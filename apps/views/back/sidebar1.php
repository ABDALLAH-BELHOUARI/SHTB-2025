<nav id="sidebar">
    ...
    <ul class="list-unstyled">
        ...
        <li>
            <a href="#smCompta" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-eur"></i> Comptabilité <i class="fa fa-angle-down dropdown-toggle-after"></i></a>
            <ul class="collapse list-unstyled" id="smCompta">
                <li>
                    <a href="?slug=versements"><i class="fa fa-money"></i> Versements</a>
                </li>
                <li>
                    <a href="?slug=virements"><i class="fa fa-exchange"></i> Ordres De Virement</a>
                </li>
                <li>
                    <a href="?slug=obsoletes"><i class="fa fa-money"></i> ODV Obsolètes</a>
                </li>
                <li>
                    <a href="?slug=remboursements"><i class="fa fa-handshake-o"></i> Remboursements</a>
                </li>
                <li>
                    <a href="#smCompta1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-credit-card"></i> Gestion Des CHQ <i class="fa fa-angle-down dropdown-toggle-after"></i></a>
                    <ul class="collapse list-unstyled" id="smCompta1">
                        <li>
                            <a href="?slug=remises"><i class="fa fa-cube"></i> Remises</a>
                        </li>
                        <li>
                            <a href="?slug=journalRemises"><i class="fa fa-cubes"></i> Journal Des Remises</a>
                        </li>
                        <li>
                            <a href="?slug=cautions"><i class="fa fa-balance-scale"></i> CHQ De Caution</a>
                        </li>
                        <li>
                            <a href="?slug=rejetes"><i class="fa fa-ban"></i> CHQ Rejetés</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="?slug=soldes"><i class="fa fa-shopping-basket"></i>Journal Des Soldes</a>
                </li>
                <li>
                    <a href="?slug=reductions"><i class="fa fa-refresh"></i>Journal Des Réductions</a>
                </li>
                <li>
                    <a href="?slug=exercice"><i class="fa fa-signal"></i>Exercice en cours</a>
                </li>
        ...
        <li>
            <a href="#smWebsite" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-globe"></i> Site WEB <i class="fa fa-angle-down dropdown-toggle-after"></i></a>
            <ul class="collapse list-unstyled" id="smWebsite">
                <li>
                    <a href="?slug=slider"><i class="fa fa-picture-o"></i> Gestion Du Slider</a>
                </li>
                <li>
                    <a href="?slug=infosweb"><i class="fa fa-info"></i> Infos Inscriptions</a>
                </li>
            </ul>
        </li>

        <li>
            <a href="#smSetting" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-sliders"></i> Règlages <i class="fa fa-angle-down dropdown-toggle-after"></i></a>
            <ul class="collapse list-unstyled" id="smSetting">
                <li>
                    <a href="?slug=shatibi"><i class="fa fa-building-o"></i> Centre Shatibi IDF</a>
                </li>
                <li>
                    <a href="?slug=params"><i class="fa fa-tachometer"></i> Paramètres</a>
                </li>
                <li>
                    <a href="?slug=extensions"><i class="fa fa-file-code-o"></i> Extensions De Fichiers</a>
                </li>
                <li>
                    <a href="?slug=bdd"><i class="fa fa-database"></i> Bases Des Données</a>
                </li>
                <li>
                    <a href="?slug=rgpd"><i class="fa fa-shield"></i> RGPD</a>
                </li>
            </ul>
        </li>
    </ul>
